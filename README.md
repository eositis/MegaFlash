...
## Hardware
The hardware is quite simple.  All the hardwork is handled by Pi Pico.  Apple 65C02 CPU only needs to copy data between RAM and Pico. Schematic is available [here](./kicad/schematic.pdf).
