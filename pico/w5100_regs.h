/**
 * W5100 register and memory layout (Uthernet II).
 * Only A0/A1 are decoded on the Apple II side → C0x0–C0x3.
 */
#ifndef _W5100_REGS_H
#define _W5100_REGS_H

#include <stdint.h>

#define U2_C0X_MASK               0x03
#define U2_C0X_MODE_REGISTER      (0x04 & U2_C0X_MASK)  /* 0 */
#define U2_C0X_ADDRESS_HIGH       (0x05 & U2_C0X_MASK)  /* 1 */
#define U2_C0X_ADDRESS_LOW        (0x06 & U2_C0X_MASK)  /* 2 */
#define U2_C0X_DATA_PORT          (0x07 & U2_C0X_MASK)  /* 3 */
